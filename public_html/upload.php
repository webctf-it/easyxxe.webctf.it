            ...
            if($isValid){
                ...
                foreach ($new_users as $user){
                    if ($user->name->__toString()){
                        $text .= "<p>Name: " . substr($user->name->__toString(),0,36) . "</p>\n";
                    }
                    if ($user->email->__toString()){
                        $text .= "<p>Email: " . substr($user->email->__toString(),0,36). "</p>\n";
                    }
                    if ($user->group->__toString()){
                        $text .= "<p>Group: " . substr($user->group->__toString(),0,36) . "</p>\n";
                    }
                    $text .= "<br>\n";
                }
